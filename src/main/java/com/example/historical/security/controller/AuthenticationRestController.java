...
import com.example.historical.security.JwtAuthenticationRequest;
import com.example.historical.security.JwtTokenUtil;
import com.example.historical.security.JwtAccount;
import com.example.historical.security.service.JwtAuthenticationResponse;
...
public class AuthenticationRestController {
    ...
    public ResponseEntity<?> refreshAndGetAuthenticationToken(HttpServletRequest request) {
        ...
        if (jwtTokenUtil.canTokenBeRefreshed(token, account.getLastPasswordResetDate())) {
